...
struct ptlrpc_bulk_desc *ptlrpc_new_bulk_md(unsigned npages, unsigned max_brw,
					 enum ptlrpc_bulk_op_type type,
					 unsigned portal,
					 const struct ptlrpc_bulk_frag_ops
						*ops);
...
void ptlrpc_fill_bulk_md(struct lnet_md *md, struct ptlrpc_bulk_desc *desc,
			 int mdcnt);
void ptlrpc_fill_bulk_md_multiple(struct lnet_md *md, struct ptlrpc_bulk_desc *desc,
			 int mdcnt);
