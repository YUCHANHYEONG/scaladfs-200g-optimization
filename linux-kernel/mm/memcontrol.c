...
EXPORT_SYMBOL(root_mem_cgroup); //Kiet
...
EXPORT_SYMBOL(memcg_alloc_page_obj_cgroups); //kiet
...
EXPORT_SYMBOL(get_obj_cgroup_from_current); //kiet
...
EXPORT_SYMBOL(__memcg_kmem_charge_page); //kiet
...
EXPORT_SYMBOL(mod_objcg_state); //kiet
...
EXPORT_SYMBOL(mem_cgroup_wb_domain); //Kiet
...
EXPORT_SYMBOL(mem_cgroup_wb_stats); //Kiet
...
EXPORT_SYMBOL(mem_cgroup_track_foreign_dirty_slowpath); //kiet
...
EXPORT_SYMBOL(mem_cgroup_flush_foreign); //kiet
...
EXPORT_SYMBOL(mem_cgroup_charge); //kiet
...
EXPORT_SYMBOL(mem_cgroup_uncharge);
