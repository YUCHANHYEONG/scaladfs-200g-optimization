...
EXPORT_SYMBOL(pm_suspended_storage); //Kiet
...
EXPORT_SYMBOL(watermark_boost_factor); //Kiet
...
EXPORT_SYMBOL(page_group_by_mobility_disabled); //Kiet
...
EXPORT_SYMBOL(deferred_pages); //Kiet
...
EXPORT_SYMBOL(get_pfnblock_flags_mask); //Kiet
...
EXPORT_SYMBOL(set_pageblock_migratetype); //Kiet
...
EXPORT_SYMBOL(prep_compound_page); //Kiet
...
EXPORT_SYMBOL(__free_pages_core); //Kiet
...
EXPORT_SYMBOL(post_alloc_hook); //Kiet
...
EXPORT_SYMBOL(move_freepages_block); //Kiet
...
EXPORT_SYMBOL(find_suitable_fallback); //Kiet
...
EXPORT_SYMBOL(drain_all_pages); //Kiet
...
EXPORT_SYMBOL(__zone_watermark_ok); //Kiet
...
EXPORT_SYMBOL(zone_watermark_ok); //Kiet
